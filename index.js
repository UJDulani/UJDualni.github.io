...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const revealElements = document.querySelectorAll('#about, #vision, #goals, #target-audience, #achievements, #services');
  ...
  // Branch/Mentor filtering (placeholder, might need actual implementation)
  
  });


// Optional: Add animation to goal and audience cards on hover
document.querySelectorAll('.goal-card, .audience-card, .service-card').forEach(card => {
  card.addEventListener('mouseenter', () => {
