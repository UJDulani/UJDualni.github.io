...
// Update the mentorsData object in your index.js file to use placeholder images
...
const mentorsData = {
  ...
  it: [
    { name: "تركي المالكي", speciality: "تقنية المعلومات", img: "/api/placeholder/120/120", about: "طالب سنة خامسة، متخصص في إدارة البنية التحتية وتقنيات الشبكات", email: "turki@example.com" },
    { name: "مها السبيعي", speciality: "تقنية المعلومات", img: "/api/placeholder/120/120", about: "خريجة، تعمل كمديرة نظم معلومات في القطاع الحكومي", email: "maha@example.com" },
    { name: "عبدالعزيز الشيخ", speciality: "تقنية المعلومات", img: "/api/placeholder/120/120", about: "طالب سنة رابعة، مهتم بأنظمة التخزين وقواعد البيانات", email: "abdulaziz@example.com" },
    { name: "سلمى الحربي", speciality: "تقنية المعلومات", img: "/api/placeholder/120/120", about: "طالبة سنة خامسة، متخصصة في دعم الأنظمة وحل المشكلات التقنية", email: "salma@example.com" },
    { name: "زياد العمري", speciality: "تقنية المعلومات", img: "/api/placeholder/120/120", about: "خريج، متخصص في إدارة المشاريع التقنية والحوكمة", email: "ziyad@example.com" },
    { name: "وجدان الغامدي", speciality: "تقنية المعلومات", img: "/api/placeholder/120/120", about: "طالبة سنة رابعة، مهتمة بخدمات تكنولوجيا المعلومات والدعم الفني", email: "wajdan@example.com" },
    { name: "بندر الشهري", speciality: "تقنية المعلومات", img: "/api/placeholder/120/120", about: "طالب سنة خامسة، متخصص في أمن المعلومات وإدارة المخاطر", email: "bandar@example.com" }
  ],
  ce: [
    { name: "فراس الحازمي", speciality: "هندسة الحاسب", img: "/api/placeholder/120/120", about: "طالب سنة خامسة، متخصص في تصميم الأنظمة المدمجة والمعالجات الدقيقة", email: "firas@example.com" },
    { name: "نجلاء القرني", speciality: "هندسة الحاسب", img: "/api/placeholder/120/120", about: "خريجة، تعمل في مجال تطوير الأجهزة والبرمجيات المدمجة", email: "najla@example.com" },
    { name: "مشاري العتيبي", speciality: "هندسة الحاسب", img: "/api/placeholder/120/120", about: "طالب سنة رابعة، مهتم بالأنظمة الرقمية والإلكترونيات", email: "mishari@example.com" },
    { name: "هند الدوسري", speciality: "هندسة الحاسب", img: "/api/placeholder/120/120", about: "طالبة سنة خامسة، متخصصة في معمارية الحاسب والأداء", email: "hind@example.com" },
    { name: "ريان الشهراني", speciality: "هندسة الحاسب", img: "/api/placeholder/120/120", about: "خريج، يعمل في تصميم وتنفيذ أنظمة التحكم الآلي", email: "rayan@example.com" },
    { name: "مرام السلمي", speciality: "هندسة الحاسب", img: "/api/placeholder/120/120", about: "طالبة سنة رابعة، مهتمة بأنظمة الزمن الحقيقي وإنترنت الأشياء", email: "maram@example.com" },
    { name: "يزيد الزهراني", speciality: "هندسة الحاسب", img: "/api/placeholder/120/120", about: "طالب سنة خامسة، متخصص في الأنظمة الموزعة والحوسبة المتوازية", email: "yazeed@example.com" }
  ]
};
